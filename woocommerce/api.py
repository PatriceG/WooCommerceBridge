...
class API(object):
    ...
    def __request(self, method, endpoint, data, params):
        ...
        if self.is_ssl is True and self.query_string_auth is False:
            ...
            params.update({"consumer_key": self.consumer_key})
            params.update({"consumer_secret": self.consumer_secret})
        else:
    ...
    def getEx(self, endpoint, params):
        """ Get requests """
        return self.__request("GET", endpoint, None, params)

    def post(self, endpoint, data):
        """ POST requests """
        return self.__request("POST", endpoint, data, None)

    def put(self, endpoint, data):
        """ PUT requests """
        return self.__request("PUT", endpoint, data, None)

    def delete(self, endpoint):
        """ DELETE requests """
        return self.__request("DELETE", endpoint, None, None)

    def options(self, endpoint):
        """ OPTIONS requests """
        return self.__request("OPTIONS", endpoint, None, None)
